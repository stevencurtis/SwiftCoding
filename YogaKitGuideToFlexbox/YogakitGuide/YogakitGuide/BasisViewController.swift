    ...
    override func viewDidLoad() {
        ...
        rootFlexContainer.flex.direction(.column).padding(100).define { (flex) in
            ...
            flex.addItem().direction(.column).define{ (flex) in
                ...
                rowWrapLabel.text = "Equal shrink for each item (20)"
                flex.addItem(rowWrapLabel)
                flex.addItem().wrap(.wrap).direction(.row).define { (flex) in
                    flex.addItem(items[0]).margin(10).basis(20)
                    flex.addItem(items[1]).margin(10).basis(20)
                    flex.addItem(items[2]).margin(10).basis(20)
                }
            }
            ...
            flex.addItem().direction(.column).define{ (flex) in
                let rowWrapLabel = UILabel()
                rowWrapLabel.numberOfLines = 0
                rowWrapLabel.text = "Equal shrink for each item (10)"
                flex.addItem(rowWrapLabel)
                flex.addItem().wrap(.wrap).direction(.row).define { (flex) in
                    flex.addItem(items[3]).margin(10).basis(20)
                    flex.addItem(items[4]).margin(10).basis(20)
                    flex.addItem(items[5]).margin(10).basis(20)
                }
            }
            ...
            flex.addItem().direction(.column).define{ (flex) in
                let rowWrapLabel = UILabel()
                rowWrapLabel.numberOfLines = 0
                rowWrapLabel.text = "Double shrink for the second item"
                flex.addItem(rowWrapLabel)
                flex.addItem().direction(.row).width(75).define { (flex) in
                    flex.addItem(items[6]).margin(10).basis(10)
                    flex.addItem(items[7]).margin(10).basis(20)
                    flex.addItem(items[8]).margin(10).basis(10)
